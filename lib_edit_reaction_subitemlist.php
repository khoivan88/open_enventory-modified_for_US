...
function getReaFields($paramHash) {
	...
	return array(
		...
		array("item" => "button", "onClick" => "searchMolecule",
			"img" => "lib/chemical_storage_sm.png", "hideReadOnly" => true,
			"class" => "button_very_small",
			"int_name" => "search_molecule",
			"text" => "Search Inventory",
		), // Suchknopf für Molekül oder Gebinde
		array("item" => "button", "onClick" => "searchReaction",
			"img" => "lib/reaction_sm.png", "hideReadOnly" => true,
			"class" => "button_very_small",
			"int_name" => "search_reaction",
			"text" => "Search Lab Notebook",
		), // Suchknopf für Reaktion
		array("item" => "button", "onClick" => "editRc",
			"img" => "lib/edit_rc_sm.png", "hideReadOnly" => true,
			"class" => "button_very_small",
			"int_name" => "editRc",
			"text" => "Edit Info",
		), // manuell eintragen
