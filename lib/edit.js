...
function printZebraLabel() {
	var url="editWin.php?mode=print_label_zebra&table="+table;
	var window1 = window.open(url,Number(new Date()),"height=220,width=450,scrollbars=yes");
...
// // Khoi: for Zebra printer set up, to be called by window.onload
// var selected_device;
// var devices = [];
