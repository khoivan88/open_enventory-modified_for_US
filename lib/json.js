...
if (!Object.prototype.toJSONString) {
    ...
    Array.prototype.toJSONString = function (w) {
        var d = [],     // The array holding the partial texts.
            i,          // Loop counter.
            l = this.length,
...
// typeof null is 'object', so watch out for that case.
                        ...
                        if (v) {
                            if (typeof v.toJSONString === 'function') {
                                d.push(k.toJSONString() + ':' +
                                       v.toJSONString(w));
                            }
                        } else {
                            d.push(k.toJSONString() + ':null');
                        }
                        break;
                    ...
                    case 'number':
                    case 'boolean':
                        d.push(k.toJSONString() + ':' + v.toJSONString());
...
// sequences.
            ...
            if (/["\\\x00-\x1f]/.test(this)) {
                return '"' + this.replace(/[\x00-\x1f\\"]/g, function (d) {
                    var c = m[d];
                    if (c) {
                        return c;
                    }
