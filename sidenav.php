...
"._script.
	...
	echo "<table class=\"hidden\"><tr>".
		...
		getJSButton("document.searchForm.reset()","lib/reset_button.png","btn_reset","link_reset_button").
		"<td>".
...
case "detail_search":
	...
	echo showHidden(array("int_name" => "fields", )).
		...
		"<fieldset id=\"doSearchFS\">
			...
			getJSButton("getAll()","lib/all.png","btn_get_all","link_all").
			getJSButton("document.searchForm.reset();perform_reset()","lib/reset_button.png","btn_reset","link_reset_button").
			"<td>".getViewRadio()."</td>
			</tr>
			</table>
		</fieldset>
