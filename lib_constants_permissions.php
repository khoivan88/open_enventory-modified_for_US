...
// Khoi: For special account for designated for borrowing from external users
define("_BORROW_EXTERNAL", 4194304); // Khoi: for special user for borrowing from external groups

$permissions_groups=array(5, 8, 6, 3, 1);
...
$permissions_list_value=array(
    ...
    "read_other" => _chemical_read + _lj_read,
    "remote_read" => _remote_read,
    "barcode_user" => _chemical_edit + _chemical_read +
        _barcode_user,
    "borrow_external" => _chemical_read + _chemical_borrow +
        _BORROW_EXTERNAL,
);
