...
<p>Felix Rudolphi und Lukas Gooßen",
	...
	"more_databases" => "Other databases",
	...
	"ex" => "is exactly",
	"eq" => "is exactly",
	"de" => "is exactly (mm/dd/yy)",    //Khoi: specify to help user type in date in correct format, only correct if date function has been changed
	"ef" => "is exactly",
	"bn" => "is exactly",
	"se" => "is exactly",
	"sn" => "stereo isomers",
	...
	"ew" => "ends with",
	"bt" => "from-to",
	"db" => "from-to (mm/dd/yy-mm/dd/yy)",   //Khoi: specify to help user type in date in correct format, only correct if date function has been changed
	"gt" => "higher than",
	"lt" => "lower than",
	"nu" => "is not set",
	"af" => "after (mm/dd/yy)",    //Khoi: specify to help user type in date in correct format, only correct if date function has been changed
	"bf" => "before (mm/dd/yy)",    //Khoi: specify to help user type in date in correct format, only correct if date function has been changed
	"du" => "unknown",
	"on" => "active",
	"of" => "inactive",
	...
	"changed_by" => "Last change by",	"molecule_created_by" => "Molecule created by",
	"molecule_changed_by" => "Molecule last changed by",
	"chemical_storage_created_by" => "Chemical container created by",
	"chemical_storage_changed_by" => "Chemical container last changed by",
	"reaction_created_by" => "Reaction created by",
	"reaction_changed_by" => "Reaction last changed by",
	"literature_created_by" => "Literature created by",
	"literature_changed_by" => "Literature last changed by",
	...
	"chemical_storage_barcode" => "barcode for chemical container",
	...
	"login_wrong_pass" => "Login failed, username or password incorrect.",
	...
	"inventory" => "Inventory",
	"komplett" => "All",
	"credits" => "About <b>Open Enventory</b>",
	"rc_safety_sym" => "",
	"rc_safety_sym_ghs" => "",
	"rc_safety_r" => "R",
	"rc_safety_h" => "H",
	...
	"realisation_templates" => "Text modules realization",
	...
	"history" => "History log",
	"history_entry" => "History log entry",
	"poison_cabinet" => "Poison cabinet",
	"owner_person_id" => "Responsible person",
	"force_poison_cabinet" => "Force using of poison cabinet for certain chemicals",
	"pos_liste" => "Positive",
	"neg_liste" => "Negative",
	"pos_neg" => "Pos.",
	...
	"storage_permanent_on" => "Set storage for all following containers: ON", // Khoi: modified for MIT
	"storage_permanent_off" => "Set storage for all following containers: OFF",  // Khoi: modified for MIT
	"no_session_data" => "Invalid session data",
	"sigle" => "Initials",
	"person_barcode" => "Person barcode",
	"storage_barcode" => "Storage barcode",
	"limit_access_to_sigle" => "Access to spectroscopic data is limited to respective initials",
...
//~ 	"alt_safety_sheet_lang" => "Language for alt. safety data sheets",
	...
	"import_file_upload" => "Upload a file (*.xls, *.csv, or tab-separated tab text) for showing a preview",
	...
	"use_bootstrap4" => "Use modern UI (Bootstrap 5)",
	"delete_multiple" => "Delete multiple containers",

	"import_edit_tab_sep" => "Import and Edit via text file",    # Only for Baylor University
	...
	"search_molecule" => "Search Inventory",    // Khoi: for buttons in lab_journal, edit reaction
	"search_reaction" => "Search Lab Notebook",    // Khoi: for buttons in lab_journal, edit reaction
	"editRc" => "Edit Info",    // Khoi: for buttons in lab_journal, edit reaction
);
