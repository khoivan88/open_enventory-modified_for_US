...
/*
    ...
    */
// Khoi: this file is added to the source code to add automatically populate barcodes for storages and users when "Existing barcode" option is used in Global Settings
// PHP first (pageHeader() starts the session and prints <html><head>), HTML after - otherwise "headers already sent".
...
<body style=\"background-color:".defBgColor."\">";
?>
">
