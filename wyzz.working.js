...
var buttonName = new Array("bold","italic","underline","strikethrough","separator","subscript","superscript","separator","justifyleft","justifycenter","justifyright","justifyfull","separator","insertunorderedlist","insertorderedlist","separator","undo","redo");
// "cut","copy","paste","separator","indent","outdent","link","insertimage","separator",

// Order of available commands in toolbar2
// Remove from this any buttons not required in your application
var buttonName2 = new Array("specialchar","separator","forecolor","backcolor","separator","inserthorizontalrule","separator","font","headers","removeformat","separator","upsize","downsize");
// ,"separator","htmlmode","separator","help","separator","removeformat"

var myFonts = new Array("Andale Mono","Georgia","Verdana","Arial","Arial Black","impact","Times New Roman","Courier New","Comic Sans MS","Helvetica","Symbol","Trebuchet MS","Tahoma");
...
function updateIframe(n) {
  ...
  if (isMSIE || isOpera) {    
    ...
    // Make the iframe editable
    doc.designMode = "on";  
	doc.documentElement.addEventListener('keyup',function() { valChanged(); }, true);
   }
  }
