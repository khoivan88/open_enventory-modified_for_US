...
page contentType="text/html" pageEncoding="UTF-8"
	...
	<body>
		<script type="text/javascript">
			var sketcher = new ChemDoodle.SketcherCanvas("sketcher", getInnerWidth() - 32, getInnerHeight() - 32, {useServices: false, oneMolecule:<%
				out.print(!"rxn".equals(request.getParameter("mode")));
			%>});
