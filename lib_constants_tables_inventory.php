...
$tables["chemical_storage"]=array(
	...
	"fields" => array(
		...
		"transferred_to_db_id" => array("type" => "INT", "fk" => "other_db", "no_ref_int" => true), // must be signed to make -1 possible
		"borrowed_by_db_id" => array("type" => "INT", "fk" => "other_db",  "no_ref_int" => true), // must be signed to make -1 possible
